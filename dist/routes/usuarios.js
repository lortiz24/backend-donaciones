...
router.post("/", [
    ...
    (0, express_validator_1.check)('rol').custom(db_validation_1.esRolValido),
    (0, express_validator_1.check)('correo').custom(db_validation_1.emailExists),
    validarCampos_1.validarCampos
], Usuario_1.createUser);
router.put('/:id', [
    (0, express_validator_1.check)('id', 'El id no es valido').isMongoId(),
    (0, express_validator_1.check)('id').custom(db_validation_1.existeUserById),
    (0, express_validator_1.check)('rol').custom(db_validation_1.esRolValido),
    validarCampos_1.validarCampos
